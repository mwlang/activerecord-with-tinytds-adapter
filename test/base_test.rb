...
class BasicsTest < Test::Unit::TestCase
  ...
  def test_preserving_date_objects
    ...
    return true if current_adapter?(:SQLServerAdapter, :TinyTdsAdapter)
  ...
  unless current_adapter?(:SQLServerAdapter, :OracleAdapter, :SybaseAdapter, :TinyTdsAdapter)
  ...
  def test_attributes_on_dummy_time
    ...
    return true if current_adapter?(:SQLServerAdapter, :OracleAdapter, :SybaseAdapter, :TinyTdsAdapter)
  ...
  def test_to_xml
    ...
    if current_adapter?(:SybaseAdapter, :SQLServerAdapter, :OracleAdapter, :TinyTdsAdapter)
  ...
  def test_include_attributes
    ...
    assert_equal(%w( title author_name type id approved ).sort, 
      topics(:first).attributes(:only => [ :title, :id, :type, :approved, :author_name ]).keys.sort)
  end
