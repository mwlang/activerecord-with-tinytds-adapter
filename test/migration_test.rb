...
if ActiveRecord::Base.connection.supports_migrations?
  ...
  class MigrationTest < Test::Unit::TestCase
    ...
    unless current_adapter?(:SQLServerAdapter, :SybaseAdapter, :SQLiteAdapter, :TinyTdsAdapter)
    ...
    def test_native_types
      ...
      if current_adapter?(:SQLServerAdapter, :OracleAdapter, :SybaseAdapter, :TinyTdsAdapter)
