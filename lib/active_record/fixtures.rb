...
class Fixtures < YAML::Omap
  ...
  def force_delete_existing_fixtures
    @connection.execute("sp_MSforeachtable 'ALTER TABLE ? NOCHECK CONSTRAINT ALL'")
    ...
    @connection.execute("sp_MSforeachtable 'ALTER TABLE ? CHECK CONSTRAINT ALL'")
  end
  ...
  def delete_existing_fixtures
    begin
      ...
      force_delete_existing_fixtures
    end
  end
